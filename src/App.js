...
function App() {
  ...
  //useState= variable in the React
  //useEffect = run code on a condition in the react.

  useEffect(() => {
    setUsername(prompt("Pease Enter Your Name"));
...
<img src="https://facebookbrand.com/wp-content/uploads/2019/10/Messenger_Logo_Color_RGB.png?w=100&h=100"/>
      <h1> Hello! From TechroHub Digital</h1>
      <h2> Welcome {username}</h2>

      <form className="app__form">
        <FormControl className="app__formControl">
          
          <Input className="app__input" value={input} placeholder="Enter a Messages...." onChange={event => setInput(event.target.value)} />
